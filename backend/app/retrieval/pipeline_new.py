...
class PipelineResult:
    ...
    # Phase 6 enhanced intelligence (optional)
    phase6_recommendations: list[IntelligentRecommendation] = field(default_factory=list)
    # Configuration
    phase6_enabled: bool = False
    phase6_intelligence: Optional[Phase6IntelligenceEngine] = None
...
def run_pipeline(
    ...
    if phase6:
        try:
            phase6_engine = Phase6IntelligenceEngine(llm)
...
def run_enhanced_pipeline(
    ...
    response = {
        ...
        "phase6_enabled": pipeline_result.phase6_enabled,
        "phase6_recommendations": [
            {
                ...
                "why_this_standard": r.why_this_standard,
                "why_not_others": r.why_not_others,
                "compliance": r.compliance,
                "lifecycle": r.lifecycle,
                "contradictions": r.contradictions,
            }
            for r in pipeline_result.phase6_recommendations
        ],
